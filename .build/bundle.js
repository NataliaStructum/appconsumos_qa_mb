...
let appconsumos_qa_mb_pages_campo_equipo_agregar_solicitud_equipos_campo_page = __webpack_require__(/*! ./appconsumos_qa_mb/Pages/Campo/Equipo/Agregar_Solicitud_Equipos_Campo.page */ "./build.definitions/appconsumos_qa_mb/Pages/Campo/Equipo/Agregar_Solicitud_Equipos_Campo.page")
let appconsumos_qa_mb_pages_campo_equipo_lista_equipos_campo_page = __webpack_require__(/*! ./appconsumos_qa_mb/Pages/Campo/Equipo/Lista_Equipos_Campo.page */ "./build.definitions/appconsumos_qa_mb/Pages/Campo/Equipo/Lista_Equipos_Campo.page")
...
let appconsumos_qa_mb_rules_campo_equipo_get_list_campo_equipoequipo_js = __webpack_require__(/*! ./appconsumos_qa_mb/Rules/Campo/Equipo/get_List_Campo_EquipoEquipo.js */ "./build.definitions/appconsumos_qa_mb/Rules/Campo/Equipo/get_List_Campo_EquipoEquipo.js")
let appconsumos_qa_mb_rules_campo_equipo_isvisible_btn_crearsolicitudesequipo_js = __webpack_require__(/*! ./appconsumos_qa_mb/Rules/Campo/Equipo/isVisible_Btn_CrearSolicitudesEquipo.js */ "./build.definitions/appconsumos_qa_mb/Rules/Campo/Equipo/isVisible_Btn_CrearSolicitudesEquipo.js")
let appconsumos_qa_mb_rules_campo_equipo_navto_list_campoequipo_js = __webpack_require__(/*! ./appconsumos_qa_mb/Rules/Campo/Equipo/NavTo_List_CampoEquipo.js */ "./build.definitions/appconsumos_qa_mb/Rules/Campo/Equipo/NavTo_List_CampoEquipo.js")
let appconsumos_qa_mb_rules_campo_equipo_target_lista_campoequipo_js = __webpack_require__(/*! ./appconsumos_qa_mb/Rules/Campo/Equipo/Target_Lista_CampoEquipo.js */ "./build.definitions/appconsumos_qa_mb/Rules/Campo/Equipo/Target_Lista_CampoEquipo.js")
...
let appconsumos_qa_mb_rules_ingenio_set_visiblebtnautorizar_js = __webpack_require__(/*! ./appconsumos_qa_mb/Rules/Ingenio/set_VisibleBtnAutorizar.js */ "./build.definitions/appconsumos_qa_mb/Rules/Ingenio/set_VisibleBtnAutorizar.js")
let appconsumos_qa_mb_rules_ingenio_set_visiblebtnnetear_js = __webpack_require__(/*! ./appconsumos_qa_mb/Rules/Ingenio/set_VisibleBtnNetear.js */ "./build.definitions/appconsumos_qa_mb/Rules/Ingenio/set_VisibleBtnNetear.js")
let appconsumos_qa_mb_rules_ingenio_set_visiblebtnrevisar_js = __webpack_require__(/*! ./appconsumos_qa_mb/Rules/Ingenio/set_VisibleBtnRevisar.js */ "./build.definitions/appconsumos_qa_mb/Rules/Ingenio/set_VisibleBtnRevisar.js")
...
module.exports = {
	...
	appconsumos_qa_mb_pages_campo_equipo_agregar_solicitud_equipos_campo_page : appconsumos_qa_mb_pages_campo_equipo_agregar_solicitud_equipos_campo_page,
	appconsumos_qa_mb_pages_campo_equipo_lista_equipos_campo_page : appconsumos_qa_mb_pages_campo_equipo_lista_equipos_campo_page,
	...
	appconsumos_qa_mb_rules_campo_equipo_get_list_campo_equipoequipo_js : appconsumos_qa_mb_rules_campo_equipo_get_list_campo_equipoequipo_js,
	appconsumos_qa_mb_rules_campo_equipo_isvisible_btn_crearsolicitudesequipo_js : appconsumos_qa_mb_rules_campo_equipo_isvisible_btn_crearsolicitudesequipo_js,
	appconsumos_qa_mb_rules_campo_equipo_navto_list_campoequipo_js : appconsumos_qa_mb_rules_campo_equipo_navto_list_campoequipo_js,
	appconsumos_qa_mb_rules_campo_equipo_target_lista_campoequipo_js : appconsumos_qa_mb_rules_campo_equipo_target_lista_campoequipo_js,
	...
	appconsumos_qa_mb_rules_ingenio_set_visiblebtnautorizar_js : appconsumos_qa_mb_rules_ingenio_set_visiblebtnautorizar_js,
	appconsumos_qa_mb_rules_ingenio_set_visiblebtnnetear_js : appconsumos_qa_mb_rules_ingenio_set_visiblebtnnetear_js,
	appconsumos_qa_mb_rules_ingenio_set_visiblebtnrevisar_js : appconsumos_qa_mb_rules_ingenio_set_visiblebtnrevisar_js,
...
/***/ "./build.definitions/appconsumos_qa_mb/Rules/Campo/Equipo/NavTo_List_CampoEquipo.js":
/*!******************************************************************************************!*\
  !*** ./build.definitions/appconsumos_qa_mb/Rules/Campo/Equipo/NavTo_List_CampoEquipo.js ***!
  \******************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ NavTo_List_CampoEquipo)
/* harmony export */ });
/**
 * Describe this function...
 * @param {IClientAPI} clientAPI
 */
function NavTo_List_CampoEquipo(context) {
...
/***/ "./build.definitions/appconsumos_qa_mb/Rules/Campo/Equipo/Target_Lista_CampoEquipo.js":
/*!********************************************************************************************!*\
  !*** ./build.definitions/appconsumos_qa_mb/Rules/Campo/Equipo/Target_Lista_CampoEquipo.js ***!
  \********************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ Target_Lista_CampoEquipo)
/* harmony export */ });
/**
 * Describe this function...
 * @param {IClientAPI} context
 */
function Target_Lista_CampoEquipo(context) {
  ...
  if (searchString) {
    let searchResult = target.filter(prod => {
      return prod.equipo.includes(searchString) || prod.centro_plan.includes(searchString) || prod.equipo_desc.includes(searchString) || prod.tipo.includes(searchString) || prod.sociedad.includes(searchString);
    });
    target = searchResult;
  }
  return target;
...
/***/ "./build.definitions/appconsumos_qa_mb/Rules/Campo/Equipo/get_List_Campo_EquipoEquipo.js":
/*!***********************************************************************************************!*\
  !*** ./build.definitions/appconsumos_qa_mb/Rules/Campo/Equipo/get_List_Campo_EquipoEquipo.js ***!
  \***********************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ get_List_Campo_EquipoEquipo)
/* harmony export */ });
/**
 * Describe this function...
 * @param {IClientAPI} clientAPI
 */
function get_List_Campo_EquipoEquipo(context) {
  const pageProxy = context.getPageProxy();
...
/***/ "./build.definitions/appconsumos_qa_mb/Rules/Campo/Equipo/isVisible_Btn_CrearSolicitudesEquipo.js":
/*!********************************************************************************************************!*\
  !*** ./build.definitions/appconsumos_qa_mb/Rules/Campo/Equipo/isVisible_Btn_CrearSolicitudesEquipo.js ***!
  \********************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ isVisible_Btn_CrearSolicitudesEquipo)
/* harmony export */ });
/**
 * Describe this function...
 * @param {IClientAPI} context
 */
function isVisible_Btn_CrearSolicitudesEquipo(context) {
  let clientData = context.evaluateTargetPathForAPI('#Page:Main').getClientData();
  let info = clientData.info_user;
...
function Select_almacen(context) {
  ...
  var btn_equipo = pageProxy.getControl("SectionedTable0").getSection("SectionFormCell0").getControl("FormCellButton3");
...
function Target_Lista_Solicitudes_Campo(context) {
  ...
  if (searchString) {
    let searchResult = target.filter(prod => {
      return prod.orden.includes(searchString) || prod.or_desc.includes(searchString) || prod.or_centro_plan.includes(searchString) || prod.or_grupo_plan.includes(searchString) || prod.equipo_solicitud.includes(searchString) || prod.eq_desc_solicitud.includes(searchString) || prod.reserva.includes(searchString) || prod.alm_sociedad.includes(searchString);
    });
    target = searchResult;
  }
  return target;
...
function Target_Lista_Materiales(context) {
  ...
  if (searchString) {
    let searchResult = target.filter(prod => {
      return prod.Matnr.includes(searchString) || prod.Txtmd.includes(searchString);
    });
    target = searchResult;
  }
  return target;
...
/***/ "./build.definitions/appconsumos_qa_mb/Rules/Ingenio/set_VisibleBtnAutorizar.js":
/*!**************************************************************************************!*\
  !*** ./build.definitions/appconsumos_qa_mb/Rules/Ingenio/set_VisibleBtnAutorizar.js ***!
  \**************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./build.definitions/appconsumos_qa_mb/Rules/Ingenio/set_VisibleBtnNetear.js":
/*!***********************************************************************************!*\
  !*** ./build.definitions/appconsumos_qa_mb/Rules/Ingenio/set_VisibleBtnNetear.js ***!
  \***********************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./build.definitions/appconsumos_qa_mb/Rules/Ingenio/set_VisibleBtnRevisar.js":
/*!************************************************************************************!*\
  !*** ./build.definitions/appconsumos_qa_mb/Rules/Ingenio/set_VisibleBtnRevisar.js ***!
  \************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
module.exports = {"Controls":[{"FilterFeedbackBar":{"ShowAllFilters":false,"_Type":"Control.Type.FilterFeedbackBar"},"_Type":"Control.Type.SectionedTable","_Name":"SectionedTable0","Sections":[{"ObjectHeader":{"Subhead":"Reserva: {reserva}","Description":"{equipo_solicitud} - {eq_desc_solicitud}","StatusText":"Almacén: {alm_almacen}","SubstatusText":"Sociedad: {alm_sociedad}","DetailImageIsCircular":false,"Tags":[{"Color":"/appconsumos_qa_mb/Rules/Campo/Color_Estado_Sol_Campo.js","Text":"Estado: {estado}"}],"BodyText":"{or_desc}","HeadlineText":"No. Orden: {orden}","StatusPosition":"Stacked","StatusImagePosition":"Leading","SubstatusImagePosition":"Leading"},"_Type":"Section.Type.ObjectHeader","_Name":"SectionObjectHeader0","Visible":true},{"Separators":{"TopSectionSeparator":false,"BottomSectionSeparator":true,"HeaderSeparator":true,"FooterSeparator":true,"ControlSeparator":true},"KeyAndValues":[{"Value":"Creado por {op_ficha} - {op_nombre}","_Type":"KeyValue.Type.Item","_Name":"KeyValue0","KeyName":"Creado el $(DT,{fecha_creacion})","Visible":true},{"Value":"{correo_creacion}","_Type":"KeyValue.Type.Item","_Name":"KeyValue3","KeyName":"Correo de Creación Solicitud","Visible":true},{"Value":"Revisado por {au_nombre}","_Type":"KeyValue.Type.Item","_Name":"KeyValue1","KeyName":"Revisado el $(DT,{fecha_revision})","Visible":true},{"Value":"Autorizado por {au_nombre}","_Type":"KeyValue.Type.Item","_Name":"KeyValue2","KeyName":"Autorizado el $(DT,{fecha_autorizado})","Visible":true}],"MaxItemCount":1,"_Type":"Section.Type.KeyValue","_Name":"SectionKeyValue0","Visible":true,"EmptySection":{"FooterVisible":false},"Layout":{"NumberOfColumns":1}},{"Separators":{"TopSectionSeparator":false,"BottomSectionSeparator":true,"HeaderSeparator":true,"FooterSeparator":true,"ControlSeparator":true},"Controls":[{"Value":"{observaciones_tec}","_Type":"Control.Type.FormCell.Note","_Name":"FormCellNote0","IsVisible":true,"Separator":true,"Caption":"Observaciones Técnico","Enabled":true,"IsEditable":false},{"Value":"{comentarios_aux}","_Type":"Control.Type.FormCell.Note","_Name":"FormCellNote1","IsVisible":true,"Separator":true,"Caption":"Observaciones Auxiliar","Enabled":true,"IsEditable":false}],"Layout":{"NumberOfColumns":1},"Visible":true,"EmptySection":{"FooterVisible":false},"_Type":"Section.Type.FormCell","_Name":"SectionFormCell0"},{"Header":{"_Type":"SectionCommon.Type.Header","_Name":"SectionCommonTypeHeader0","AccessoryType":"None","UseTopPadding":true,"Caption":"Materiales de la Solicitud"},"Separators":{"TopSectionSeparator":false,"BottomSectionSeparator":true,"HeaderSeparator":true,"FooterSeparator":true,"ControlSeparator":true},"Grouping":{"GroupingProperties":[],"Header":{"Items":[]}},"_Type":"Section.Type.ObjectTable","Target":{"Service":"/appconsumos_qa_mb/Services/app_consumos_qa.service","EntitySet":"ComponentesSolicitud","QueryOptions":"/appconsumos_qa_mb/Rules/Campo/Query_Detalle_Componentes_Campo.js","ReadLink":"{@odata.readLink}"},"_Name":"SectionObjectTable0","Visible":true,"EmptySection":{"Caption":"No hay elementos para mostrar","FooterVisible":false},"ObjectCell":{"ContextMenu":{"Items":[],"PerformFirstActionWithFullSwipe":true,"LeadingItems":[],"TrailingItems":[],"_Type":"ObjectCell.Type.ContextMenu"},"Title":"{material_material}","Subhead":"Tomado de: {almacen_almacen}","Description":"{material/material_desc}","DisplayDescriptionInMobile":true,"StatusText":"Cant. Solicitada: {cantidad_tomada}","SubstatusText":"Cant. Aprobada: {cantidad_aprobada}","PreserveIconStackSpacing":false,"AccessoryType":"None","Tags":[{"Color":"Grey","Text":"Entregado: {confirmacion_tec}"}],"AvatarStack":{"Avatars":[{"Image":"sap-icon://product"}],"ImageIsCircular":true,"ImageHasBorder":false},"AvatarGrid":{"Avatars":[],"ImageIsCircular":true},"_Type":"ObjectTable.Type.ObjectCell","Selected":false},"DataPaging":{"ShowLoadingIndicator":false,"PageSize":50},"HighlightSelectedItem":false,"Selection":{"ExitOnLastDeselect":true,"LongPressToEnable":"None","Mode":"None"}}]}],"_Type":"Page","_Name":"Detalle_Solicitudes_Campo","ActionBar":{"Items":[],"_Name":"ActionBar3","_Type":"Control.Type.ActionBar","Caption":"Detalle Solicitud Campo"}}

/***/ }),

/***/ "./build.definitions/appconsumos_qa_mb/Pages/Campo/Equipo/Agregar_Solicitud_Equipos_Campo.page":
/*!*****************************************************************************************************!*\
  !*** ./build.definitions/appconsumos_qa_mb/Pages/Campo/Equipo/Agregar_Solicitud_Equipos_Campo.page ***!
  \*****************************************************************************************************/
/***/ ((module) => {

module.exports = {"Controls":[{"_Type":"Control.Type.SectionedTable","_Name":"SectionedTable0","FilterFeedbackBar":{"ShowAllFilters":false,"_Type":"Control.Type.FilterFeedbackBar"}}],"_Type":"Page","_Name":"Agregar_Solicitud_Equipos_Campo","ActionBar":{"Items":[],"_Name":"ActionBar1","_Type":"Control.Type.ActionBar","Caption":"Nueva Solicitud Campo"}}

/***/ }),

/***/ "./build.definitions/appconsumos_qa_mb/Pages/Campo/Equipo/Lista_Equipos_Campo.page":
/*!*****************************************************************************************!*\
  !*** ./build.definitions/appconsumos_qa_mb/Pages/Campo/Equipo/Lista_Equipos_Campo.page ***!
  \*****************************************************************************************/
/***/ ((module) => {

module.exports = {"Controls":[{"FilterFeedbackBar":{"ShowAllFilters":false,"_Type":"Control.Type.FilterFeedbackBar"},"_Type":"Control.Type.SectionedTable","_Name":"SectionedTable0","Sections":[{"Separators":{"TopSectionSeparator":false,"BottomSectionSeparator":true,"HeaderSeparator":true,"FooterSeparator":true,"ControlSeparator":true},"Controls":[{"_Type":"Control.Type.FormCell.ListPicker","_Name":"filtro_equipos","RequiredIndicator":false,"IsVisible":true,"Separator":true,"AllowMultipleSelection":false,"AllowEmptySelection":true,"Caption":"Equipo","DataPaging":{"ShowLoadingIndicator":false,"PageSize":50},"PickerPrompt":"Selecciona un equipo","HelperText":"Debes seleccionar al menos un equipo para mostrar el resultado","OnValueChange":"/appconsumos_qa_mb/Rules/Campo/Equipo/get_List_Campo_EquipoEquipo.js","IsSelectedSectionEnabled":false,"IsPickerDismissedOnSelection":true,"IsSearchCancelledAfterSelection":false,"AllowDefaultValueIfOneItem":false,"IsEditable":true,"Search":{"Enabled":true,"Placeholder":"Buscar equipo...","BarcodeScanner":true},"PickerItems":{"Target":{"Service":"/appconsumos_qa_mb/Services/app_consumos_qa.service","EntitySet":"Equipos","QueryOptions":"$filter=centro eq '{{#Page:Filtro_Campo/#ClientData/centro}}' and sociedad eq '{{#Page:Main/#ClientData/info_user/sociedad}}'"},"ObjectCell":{"Description":"{equipo_desc}","PreserveIconStackSpacing":false,"StatusText":"{centro}","Subhead":"{tipo}","SubstatusText":"{sociedad}","Title":"{equipo}","Visible":true},"ReturnValue":"{equipo}"}}],"Layout":{"NumberOfColumns":1},"Visible":true,"EmptySection":{"FooterVisible":false},"_Type":"Section.Type.FormCell","_Name":"SectionFormCell0"},{"Separators":{"TopSectionSeparator":false,"BottomSectionSeparator":true,"HeaderSeparator":true,"FooterSeparator":true,"ControlSeparator":true},"Grouping":{"GroupingProperties":[],"Header":{"Items":[]}},"Header":{"_Type":"SectionCommon.Type.Header","_Name":"SectionCommonTypeHeader0","AccessoryType":"None","UseTopPadding":true,"Caption":"Equipo seleccionado"},"_Type":"Section.Type.ObjectTable","Target":"/appconsumos_qa_mb/Rules/Campo/Equipo/Target_Lista_CampoEquipo.js","_Name":"SectionObjectTable0","Visible":true,"EmptySection":{"Caption":"No hay Equipos para mostrar","FooterVisible":false},"ObjectCell":{"ContextMenu":{"Items":[],"PerformFirstActionWithFullSwipe":true,"LeadingItems":[],"TrailingItems":[],"_Type":"ObjectCell.Type.ContextMenu"},"Title":"{equipo}","Subhead":"{tipo}","Footnote":"{grupo_plan}","Description":"{equipo_desc}","DisplayDescriptionInMobile":true,"StatusText":"{centro}","SubstatusText":"{sociedad}","PreserveIconStackSpacing":false,"AccessoryType":"None","Tags":[],"AvatarStack":{"Avatars":[{"Image":"sap-icon://inventory"}],"ImageIsCircular":false,"ImageHasBorder":false},"AvatarGrid":{"Avatars":[],"ImageIsCircular":false},"OnPress":{"Name":"/appconsumos_qa_mb/Actions/GenericNavigation.action","Properties":{"PageToOpen":"/appconsumos_qa_mb/Pages/Campo/Equipo/Agregar_Solicitud_Equipos_Campo.page"}},"_Type":"ObjectTable.Type.ObjectCell","Selected":false},"DataPaging":{"ShowLoadingIndicator":false,"PageSize":50},"HighlightSelectedItem":false,"Selection":{"ExitOnLastDeselect":true,"LongPressToEnable":"None","Mode":"None"}}]}],"_Type":"Page","_Name":"Lista_Equipos_Campo","ActionBar":{"Items":[],"_Name":"ActionBar3","_Type":"Control.Type.ActionBar","Caption":"Lista Equipos Campo"}}
...
module.exports = {"Controls":[{"FilterFeedbackBar":{"ShowAllFilters":false,"_Type":"Control.Type.FilterFeedbackBar"},"_Type":"Control.Type.SectionedTable","_Name":"SectionedTable0","Sections":[{"ObjectHeader":{"DetailImageIsCircular":false,"HeadlineText":"Modulo órdenes de mantemiento en Campo","StatusPosition":"Stacked","StatusImagePosition":"Leading","SubstatusImagePosition":"Leading","Styles":{"ObjectHeader":"HeaderAdmin","HeadlineText":"HeaderAdminTitle"}},"_Type":"Section.Type.ObjectHeader","_Name":"SectionObjectHeader0","Visible":true},{"Separators":{"TopSectionSeparator":false,"BottomSectionSeparator":true,"HeaderSeparator":true,"FooterSeparator":true,"ControlSeparator":true},"Controls":[{"_Type":"Control.Type.FormCell.ListPicker","_Name":"almacen_campo","RequiredIndicator":false,"IsVisible":true,"Separator":true,"AllowMultipleSelection":false,"AllowEmptySelection":true,"Caption":"Almacén","DataPaging":{"ShowLoadingIndicator":false,"PageSize":50},"PickerPrompt":"Selecciona un almacén","HelperText":"Debes seleccionar un almacén para continuar","OnValueChange":"/appconsumos_qa_mb/Rules/Campo/Select_almacen.js","IsSelectedSectionEnabled":false,"IsPickerDismissedOnSelection":true,"AllowDefaultValueIfOneItem":false,"IsEditable":true,"PickerItems":{"Target":{"Service":"/appconsumos_qa_mb/Services/app_consumos_qa.service","EntitySet":"AlmacenesApp","QueryOptions":"$filter=sociedad eq '{{#Page:Main/#ClientData/info_user/sociedad}}' and tipo eq 'CAMPO'&$orderby=almacen"},"ObjectCell":{"PreserveIconStackSpacing":false,"StatusText":"{sociedad}","Subhead":"{tipo}","SubstatusText":"{centro}","Title":"{almacen} - {almacen_desc}","Visible":true},"ReturnValue":"{almacen}"}},{"_Type":"Control.Type.FormCell.Button","_Name":"FormCellButton0","RequiredIndicator":false,"IsVisible":"/appconsumos_qa_mb/Rules/Campo/isVisible_Btn_CrearSolicitudes.js","Separator":true,"Styles":{"Image":"Button","Button":"Button"},"Title":"Órdenes y Crear Solicitudes","Alignment":"Center","ButtonType":"Primary","Semantic":"Tint","Image":"sap-icon://create-form","ImagePosition":"Leading","Enabled":false,"OnPress":"/appconsumos_qa_mb/Rules/Campo/NavTo_List_Campo.js"},{"_Type":"Control.Type.FormCell.Button","_Name":"FormCellButton3","RequiredIndicator":false,"IsVisible":"/appconsumos_qa_mb/Rules/Campo/Equipo/isVisible_Btn_CrearSolicitudesEquipo.js","Separator":true,"Styles":{"Image":"Button","Button":"Button"},"Title":"Equipos y Crear Solicutudes","Alignment":"Center","ButtonType":"Primary","Semantic":"Tint","Image":"sap-icon://add-equipment","ImagePosition":"Leading","Enabled":false,"OnPress":"/appconsumos_qa_mb/Rules/Campo/Equipo/NavTo_List_CampoEquipo.js"},{"_Type":"Control.Type.FormCell.Button","_Name":"FormCellButton1","RequiredIndicator":false,"IsVisible":true,"Separator":true,"Styles":{"Image":"Button","Button":"Button"},"Title":"Solicitudes Vigentes","Alignment":"Center","ButtonType":"Primary","Semantic":"Tint","Image":"sap-icon://approvals","ImagePosition":"Leading","Enabled":false,"OnPress":"/appconsumos_qa_mb/Rules/Campo/NavTo_List_Sol_Campo.js"},{"_Type":"Control.Type.FormCell.Button","_Name":"FormCellButton2","RequiredIndicator":false,"IsVisible":true,"Separator":true,"Styles":{"Image":"Button","Button":"Button"},"Title":"Histórico de Solicitudes","Alignment":"Center","ButtonType":"Primary","Semantic":"Tint","Image":"sap-icon://detail-view","ImagePosition":"Leading","Enabled":false}],"Layout":{"NumberOfColumns":1},"Visible":true,"EmptySection":{"FooterVisible":false},"_Type":"Section.Type.FormCell","_Name":"SectionFormCell0"}]}],"_Type":"Page","_Name":"Filtro_Campo","ActionBar":{"Items":[],"_Name":"ActionBar4","_Type":"Control.Type.ActionBar","Caption":"Órdenes y Equipos Campo"}}
...
module.exports = {"Controls":[{"_Type":"Control.Type.SectionedTable","_Name":"SectionedTable0","Sections":[{"_Type":"Section.Type.ObjectHeader","_Name":"SectionObjectHeader0","ObjectHeader":{"Subhead":"Reserva: {reserva}","Description":"{equipo_solicitud} - {eq_desc_solicitud}","StatusText":"Almacén: {alm_almacen}","SubstatusText":"Sociedad: {alm_sociedad}","DetailImageIsCircular":false,"Tags":[{"Color":"/appconsumos_qa_mb/Rules/Campo/Color_Estado_Sol_Campo.js","Text":"Estado: {estado}"}],"BodyText":"{or_desc}","HeadlineText":"No. Orden: {orden}","StatusPosition":"Stacked","StatusImagePosition":"Leading","SubstatusImagePosition":"Leading"},"Visible":true},{"_Type":"Section.Type.KeyValue","_Name":"SectionKeyValue0","Visible":true,"EmptySection":{"FooterVisible":false},"Separators":{"TopSectionSeparator":false,"BottomSectionSeparator":true,"HeaderSeparator":true,"FooterSeparator":true,"ControlSeparator":true},"KeyAndValues":[{"Value":"Creado por {op_ficha} - {op_nombre}","_Type":"KeyValue.Type.Item","_Name":"KeyValue0","KeyName":"Creado el $(DT,{fecha_creacion})","Visible":true},{"Value":"{correo_creacion}","_Type":"KeyValue.Type.Item","_Name":"KeyValue3","KeyName":"Correo de Creación Solicitud","Visible":true},{"Value":"Revisado por {au_nombre}","_Type":"KeyValue.Type.Item","_Name":"KeyValue1","KeyName":"Revisado el $(DT,{fecha_revision})","Visible":true},{"Value":"Autorizado por {au_nombre}","_Type":"KeyValue.Type.Item","_Name":"KeyValue2","KeyName":"Autorizado el $(DT,{fecha_autorizado})","Visible":true}],"MaxItemCount":1,"Layout":{"NumberOfColumns":1}},{"Visible":true,"EmptySection":{"FooterVisible":false},"Separators":{"TopSectionSeparator":false,"BottomSectionSeparator":true,"HeaderSeparator":true,"FooterSeparator":true,"ControlSeparator":true},"_Type":"Section.Type.FormCell","_Name":"SectionFormCell0","Controls":[{"Value":"{observaciones_tec}","_Type":"Control.Type.FormCell.Note","_Name":"FormCellNote0","IsVisible":true,"Separator":true,"Caption":"Observaciones Técnico","Enabled":true,"IsEditable":false},{"Value":"{comentarios_aux}","_Type":"Control.Type.FormCell.Note","_Name":"FormCellNote1","IsVisible":true,"Separator":true,"Caption":"Observaciones Auxiliar","Enabled":true,"IsEditable":false}],"Layout":{"NumberOfColumns":1}},{"_Type":"Section.Type.ObjectTable","Target":{"Service":"/appconsumos_qa_mb/Services/app_consumos_qa.service","EntitySet":"ComponentesSolicitud","QueryOptions":"/appconsumos_qa_mb/Rules/Ingenio/Query_Detalle_Componentes_Ingenio.js","ReadLink":"{@odata.readLink}"},"_Name":"SectionObjectTable0","Header":{"_Type":"SectionCommon.Type.Header","_Name":"SectionCommonTypeHeader0","AccessoryType":"None","UseTopPadding":true,"Caption":"Materiales de la Solicitud"},"Visible":true,"EmptySection":{"Caption":"No hay elementos para mostrar","FooterVisible":false},"Separators":{"TopSectionSeparator":false,"BottomSectionSeparator":true,"HeaderSeparator":true,"FooterSeparator":true,"ControlSeparator":true},"ObjectCell":{"Title":"Material: {mat_nuevo}","Subhead":"Tomado de: {almacen_almacen}","Description":"{mat_nuevo_desc}","DisplayDescriptionInMobile":true,"StatusText":"Cant. Solicitada: {cantidad_tomada}","SubstatusText":"Cant. Aprobada: {cantidad_aprobada}","PreserveIconStackSpacing":false,"AccessoryType":"None","Tags":[{"Color":"Grey","Text":"Entregado: {confirmacion_tec}"}],"AvatarStack":{"Avatars":[{"Image":"sap-icon://product"}],"ImageIsCircular":true,"ImageHasBorder":false},"AvatarGrid":{"Avatars":[],"ImageIsCircular":true},"_Type":"ObjectTable.Type.ObjectCell","Selected":false,"ContextMenu":{"Items":[],"PerformFirstActionWithFullSwipe":true,"LeadingItems":[],"TrailingItems":[],"_Type":"ObjectCell.Type.ContextMenu"}},"DataPaging":{"ShowLoadingIndicator":false,"PageSize":50},"Grouping":{"GroupingProperties":[],"Header":{"Items":[]}},"HighlightSelectedItem":false,"Selection":{"ExitOnLastDeselect":true,"LongPressToEnable":"None","Mode":"None"}}],"FilterFeedbackBar":{"ShowAllFilters":false,"_Type":"Control.Type.FilterFeedbackBar"}}],"_Type":"Page","_Name":"Detalle_Solicitudes_Ingenio","ActionBar":{"Items":[],"_Name":"ActionBar1","_Type":"Control.Type.ActionBar","Caption":"Detalle Solicitud Ingenio"},"FioriToolbar":{"_Type":"Control.Type.FioriToolbar","_Name":"FioriToolbar0","Items":[{"_Type":"FioriToolbarItem.Type.Button","_Name":"btn_Autorizar","Visible":"/appconsumos_qa_mb/Rules/Ingenio/set_VisibleBtnAutorizar.js","Title":"Autorizar","Styles":{"Button":"Button"},"Image":"sap-icon://accounting-document-verification","Enabled":true,"ButtonType":"Primary","Semantic":"Tint","ImagePosition":"Leading"},{"_Type":"FioriToolbarItem.Type.Button","_Name":"btn_Revisar","Visible":"/appconsumos_qa_mb/Rules/Ingenio/set_VisibleBtnRevisar.js","Title":"Revisar","Styles":{"Button":"Button"},"Image":"sap-icon://write-new-document","Enabled":true,"ButtonType":"Primary","Semantic":"Tint","ImagePosition":"Leading"},{"_Type":"FioriToolbarItem.Type.Button","_Name":"btn_Netear","Visible":"/appconsumos_qa_mb/Rules/Ingenio/set_VisibleBtnNetear.js","Title":"Netear","Styles":{"Button":"Button"},"Image":"sap-icon://inspect-down","Enabled":true,"ButtonType":"Primary","Semantic":"Tint","ImagePosition":"Leading"}]}}
...
module.exports = {"Controls":[{"FilterFeedbackBar":{"ShowAllFilters":false,"_Type":"Control.Type.FilterFeedbackBar"},"_Type":"Control.Type.SectionedTable","_Name":"SectionedTable0","Sections":[{"ObjectHeader":{"StatusText":"Centro: {almacen_centro}","SubstatusText":"{almacen_sociedad}","DetailImageIsCircular":false,"Tags":[{"Color":"/appconsumos_qa_mb/Rules/Inventario/Color_Estado_Abast.js","Text":"{estado}"}],"HeadlineText":"Almacén: {almacen_almacen} - {almacen/almacen_desc}","StatusPosition":"Stacked","StatusImagePosition":"Leading","SubstatusImagePosition":"Leading"},"_Type":"Section.Type.ObjectHeader","_Name":"SectionObjectHeader0","Visible":true},{"Separators":{"TopSectionSeparator":false,"BottomSectionSeparator":true,"HeaderSeparator":true,"FooterSeparator":true,"ControlSeparator":true},"KeyAndValues":[{"Value":"Creado por {operario_ficha} - {operario/nombre}","_Type":"KeyValue.Type.Item","_Name":"KeyValue0","KeyName":"Creado el $(DT,{fecha_creacion})","Visible":true},{"Value":"{correo_creacion}","_Type":"KeyValue.Type.Item","_Name":"KeyValue1","KeyName":"Correo de Creación Solicitud","Visible":true},{"Value":"Revisado por {aprobador/nombre}","_Type":"KeyValue.Type.Item","_Name":"KeyValue2","KeyName":"Revisado el $(DT,{fecha_revision})","Visible":true},{"Value":"Autorizado por {autorizador/nombre}","_Type":"KeyValue.Type.Item","_Name":"KeyValue3","KeyName":"Autorizado el $(DT,{fecha_autorizado})","Visible":true}],"MaxItemCount":1,"_Type":"Section.Type.KeyValue","_Name":"SectionKeyValue0","Visible":true,"EmptySection":{"FooterVisible":false},"Layout":{"NumberOfColumns":1}},{"Visible":true,"EmptySection":{"FooterVisible":false},"Separators":{"TopSectionSeparator":false,"BottomSectionSeparator":true,"HeaderSeparator":true,"FooterSeparator":true,"ControlSeparator":true},"_Type":"Section.Type.FormCell","_Name":"SectionFormCell0","Controls":[{"Value":"{observaciones_tec}","_Type":"Control.Type.FormCell.Note","_Name":"FormCellNote0","IsVisible":true,"Separator":true,"Caption":"Observaciones Técnico","Enabled":true,"IsEditable":false},{"Value":"{comentarios_aux}","_Type":"Control.Type.FormCell.Note","_Name":"FormCellNote1","IsVisible":true,"Separator":true,"Caption":"Observaciones Auxiliar","Enabled":true,"IsEditable":false}],"Layout":{"NumberOfColumns":1}},{"Separators":{"TopSectionSeparator":false,"BottomSectionSeparator":true,"HeaderSeparator":true,"FooterSeparator":true,"ControlSeparator":true},"Header":{"_Type":"SectionCommon.Type.Header","_Name":"SectionCommonTypeHeader0","AccessoryType":"None","UseTopPadding":true,"Caption":"Materiales de la Solicitud"},"Grouping":{"GroupingProperties":[],"Header":{"Items":[]}},"_Type":"Section.Type.ObjectTable","Target":{"Service":"/appconsumos_qa_mb/Services/app_consumos_qa.service","EntitySet":"ComponentesSolicitud","QueryOptions":"/appconsumos_qa_mb/Rules/Inventario/Query_Detalle_Componentes_Abast.js","ReadLink":"{@odata.readLink}"},"_Name":"SectionObjectTable0","Visible":true,"EmptySection":{"FooterVisible":false},"ObjectCell":{"ContextMenu":{"Items":[],"PerformFirstActionWithFullSwipe":true,"LeadingItems":[],"TrailingItems":[],"_Type":"ObjectCell.Type.ContextMenu"},"Title":"{material_material}","Footnote":"Entregado: {confirmacion_tec}","Description":"{material/material_desc}","DisplayDescriptionInMobile":true,"StatusText":"Cant. Solicitada: {cantidad_tomada}","SubstatusText":"Cant. Aprobada: {cantidad_aprobada}","PreserveIconStackSpacing":false,"AccessoryType":"None","Tags":[{"Color":"Grey","Text":"Registrado"}],"AvatarStack":{"Avatars":[{"Image":"sap-icon://product"}],"ImageIsCircular":true,"ImageHasBorder":false},"AvatarGrid":{"Avatars":[],"ImageIsCircular":true},"_Type":"ObjectTable.Type.ObjectCell","Selected":false},"DataPaging":{"ShowLoadingIndicator":false,"PageSize":50},"HighlightSelectedItem":false,"Selection":{"ExitOnLastDeselect":true,"LongPressToEnable":"None","Mode":"None"}},{"Separators":{"TopSectionSeparator":false,"BottomSectionSeparator":true,"HeaderSeparator":true,"FooterSeparator":true,"ControlSeparator":true},"Grouping":{"GroupingProperties":[],"Header":{"Items":[]}},"_Type":"Section.Type.ObjectTable","Target":{"Service":"/appconsumos_qa_mb/Services/app_consumos_qa.service","EntitySet":"ComponentesSolicitud","QueryOptions":"/appconsumos_qa_mb/Rules/Inventario/Query_Detalle_Componentes_Abast_Nuevo.js","ReadLink":"{@odata.readLink}"},"_Name":"SectionObjectTable1","Visible":true,"EmptySection":{"FooterVisible":false},"ObjectCell":{"ContextMenu":{"Items":[],"PerformFirstActionWithFullSwipe":true,"LeadingItems":[],"TrailingItems":[],"_Type":"ObjectCell.Type.ContextMenu"},"Title":"{mat_nuevo}","Footnote":"Entregado: {confirmacion_tec}","Description":"{mat_nuevo_desc}","DisplayDescriptionInMobile":true,"StatusText":"Cant. Solicitada: {cantidad_tomada}","SubstatusText":"Cant. Aprobada: {cantidad_aprobada}","PreserveIconStackSpacing":false,"AccessoryType":"None","Tags":[{"Color":"Mango","Text":"Nuevo"}],"AvatarStack":{"Avatars":[{"Image":"sap-icon://product"}],"ImageIsCircular":true,"ImageHasBorder":false},"AvatarGrid":{"Avatars":[],"ImageIsCircular":true},"_Type":"ObjectTable.Type.ObjectCell","Selected":false},"DataPaging":{"ShowLoadingIndicator":false,"PageSize":50},"HighlightSelectedItem":false,"Selection":{"ExitOnLastDeselect":true,"LongPressToEnable":"None","Mode":"None"}}]}],"_Type":"Page","_Name":"Detalle_Solicitud_Reabastecimieto","ActionBar":{"Items":[],"_Name":"ActionBar5","_Type":"Control.Type.ActionBar","Caption":"Detalle Solicitud Abastecimiento"}}
...
module.exports = {"Controls":[{"FilterFeedbackBar":{"ShowAllFilters":false,"_Type":"Control.Type.FilterFeedbackBar"},"_Type":"Control.Type.SectionedTable","_Name":"SectionedTable0","Sections":[{"ObjectHeader":{"DetailImageIsCircular":false,"HeadlineText":"Modulo Inventario","StatusPosition":"Stacked","StatusImagePosition":"Leading","SubstatusImagePosition":"Leading","Styles":{"ObjectHeader":"HeaderAdmin","HeadlineText":"HeaderAdminTitle"}},"_Type":"Section.Type.ObjectHeader","_Name":"SectionObjectHeader0","Visible":true},{"Separators":{"TopSectionSeparator":false,"BottomSectionSeparator":true,"HeaderSeparator":true,"FooterSeparator":true,"ControlSeparator":true},"_Type":"Section.Type.ContactCell","_Name":"SectionContactCell0","Visible":true,"EmptySection":{"FooterVisible":false},"ContactCells":[{"ContactCell":{"ContextMenu":{"PerformFirstActionWithFullSwipe":true},"_Name":"ContactCellItem0","DetailImage":"sap-icon://request","Headline":"Solicitudes de Reabastecimiento","Subheadline":"Ver listado de solicitudes de reabastecimiento y realizar solicitudes ","Description":"","Visible":true,"OnPress":"/appconsumos_qa_mb/Rules/Inventario/NavTo_Filtro_Abast.js"}},{"ContactCell":{"ContextMenu":{"PerformFirstActionWithFullSwipe":true},"_Name":"ContactCellItem1","DetailImage":"sap-icon://add-product","Headline":"Consultar Inventario","Subheadline":"Inventario de almacenes","Description":"","Visible":true}}]}]}],"_Type":"Page","_Name":"Inicio_Inventario","ActionBar":{"Items":[],"_Name":"ActionBar4","_Type":"Control.Type.ActionBar"}}
