 ...
 */
export default function Validate_Req_Create_Solicitud_CampoEquipo(context) {
    let clientDataDetalle = context.evaluateTargetPathForAPI('#Page:Lista_Equipos_Campo').getClientData();
    clientDataDetalle.lista_materiales
    let ficha = context.evaluateTargetPath('#Page:Agregar_Solicitud_Equipos_Campo/#Control:ficha/#Value');
    if(ficha){
                ...
                if(clientDataDetalle.lista_materiales && clientDataDetalle.lista_materiales.length > 0 ){
                    return context.executeAction({
                        ...
                        "Properties": {
                            ...
                            "OKCaption": "Aceptar",
                            "OnOK": "/appconsumos_qa_mb/Actions/oData/Equipo/Create_Solicitud_CampoEquipo.action",
