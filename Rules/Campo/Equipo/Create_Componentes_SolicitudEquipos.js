 ...
 */
export default function Create_Componentes_SolicitudEquipos(context) {
    let actionResult = context.getActionResult("Create_Solicitud_CampoEquipo")
    ...
    return Promise.allSettled(promises).then(() => {
        ...
        return context.executeAction({
            ...
            return context.executeAction({
                ...
                "NavigateBackToPage": "/appconsumos_qa_mb/Pages/Campo/Equipo/Lista_Equipos_Campo.page"
            });
        });
    });
