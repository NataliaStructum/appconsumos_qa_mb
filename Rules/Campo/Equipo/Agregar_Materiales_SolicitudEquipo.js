 ...
 */
export default function Agregar_Materiales_SolicitudEquipo(context) {
    const pageProxy = context.getPageProxy();
    let clientData = context.evaluateTargetPathForAPI('#Page:Lista_Equipos_Campo').getClientData();

    let material = context.evaluateTargetPath('#Page:Agregar_Solicitud_Equipos_Campo/#Control:material/#Value');
    let cant = context.evaluateTargetPath('#Page:Agregar_Solicitud_Equipos_Campo/#Control:cantidad/#Value');
