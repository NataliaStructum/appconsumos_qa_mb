 ...
 */
export default function Target_Lista_MaterialesEquipo(context) {

    let target = context.evaluateTargetPath("#Page:Lista_Equipos_Campo/#ClientData/#Property:lista_materiales");
