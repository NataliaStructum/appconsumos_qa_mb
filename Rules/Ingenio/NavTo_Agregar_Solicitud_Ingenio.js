...
export default function NavTo_Agregar_Solicitud_Ingenio(context) {
    ...
    return context.read('/appconsumos_qa_mb/Services/app_consumos_qa.service', 'AlmacenesApp', [], `$filter=tipo eq 'INGENIO' and  sociedad eq '${clientDataMain.info_user.sociedad}'`).then(async (results) => {
        ...
        if (results && results.length > 0) {
            ...
            await context.executeAction({
                ...
                "Properties": {
                    ...
                    "OnSuccess": "",
                    "Target": {
                        "Service": "/appconsumos_qa_mb/Services/ZBODEGA_AGO_SRV.service",
